const MemberCard = ({ member }) => {
  return (
    <div className="card card-custom p-0 overflow-hidden shadow-sm text-center">
      ...
      <div className="card-body pt-3 pb-4 px-4">
        ...
        <p className="card-text text-muted mb-3">{member.role}</p>

        {/* SOCIAL ICONS */}
        <div className="d-flex justify-content-center gap-3">
          <a href="#" className="text-secondary text-decoration-none hover-gold">
